...
async function run() {
  const addresses = [
    'Lotus\'s near Taman Desa Duyong, Melaka, Malaysia',
    'Lotus\'s near 75460 Ayer Molek, Melaka, Malaysia',
    'Lotus\'s near Bemban, Malacca, Malaysia',
    'Mydin near Bemban, Malacca, Malaysia'
  ];
